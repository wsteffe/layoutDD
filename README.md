...
The most used fire format for the definition of a PCB sytructure is ODB++. Unfortunately an open source reader 
of this format is not yet available so I decided to import the layout geometry from dxf and gdsii files.
